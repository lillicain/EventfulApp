...
//        .init(id: NSUUID().uuidString, userUid: NSUserName(), description: "Pangea Image", count: 0, imageUrl: "", location: "610 South Tech Ridge Drive, Saint George, UT"),
//        .init(id: NSUUID().uuidString, userUid: NSUserName(), description: "Pangea", count: 0, imageUrl: "", location: "610 South Tech Ridge Drive, Saint George, UT"),
//        .init(id: NSUUID().uuidString, userUid: NSUserName(), description: "Pangea", count: 0, imageUrl: "", location: "610 South Tech Ridge Drive, Saint George, UT")
